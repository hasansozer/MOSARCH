...
import numpy as np
import time
from alloldfunctions import myCost, RouletteWheelSelection, Crossover, Mutation, myCostJaya, CrossoverJAYA, MutationJAYA, Jaya
import copy
def HYGARI(inputdata):
    ...
    for iteration in range(MaxIt):
        ...
        BestCost=BestSol[1]
        with open(outFileName + "-HYGARI.csv", 'a+') as f:
            toc_iter = time.time()
